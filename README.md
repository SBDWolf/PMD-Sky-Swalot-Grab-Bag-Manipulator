...
The bulk of this web app has been AI-generated (by open models). It has been tested to work as expected and manually adjusted a little in its presentation. Below is the original Readme as generated by the model. To understand how manips work, refer to the [article on the PMD Speedrunning Wiki](https://pmdspeedruns.miraheze.org/wiki/EoS_Bazaar_Manipulations).
